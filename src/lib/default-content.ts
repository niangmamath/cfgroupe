...
export const defaultContent: SiteContent = {
  ...
  presence: {
    title: "Présence de CFConsulting",
    backgroundImage: "/world-map.svg",
    locations: [
      {
        id: "casablanca",
        city: "Casablanca",
  ...
  trustedSection: {
    title: "La confiance de nos clients et de nos partenaires",
  ...
  homeSectionOrder: [
    ...
    { kind: "fixed", key: "presence" },
    { kind: "fixed", key: "trustedLogos" },
